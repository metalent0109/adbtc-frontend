            ...
            <Grid item xs={12}>
              ...
              <Box sx={{ border: '1px solid #ddd' }} p={2}>
                ...
                <Typography variant='body1' sx={{ marginBottom: '1rem', fontSize: '1.4rem' }}>
                  Freecash.com | Fastest Growing Site to Earn Bitcoin (2021) | Instant withdrawals
                </Typography>
                <Typography variant='body1' sx={{ marginBottom: '2rem' }}>
                  Price: <b>25.9 satoshis</b>
                </Typography>

                <Link component='button' underline='none' onClick={() => navigate('/surf/abuse')}>
                  Report Ad
                </Link>
                <Typography variant='body1' sx={{ marginTop: '1.5rem' }}>
                  <b>You closed page</b><br />
              ...
              <Typography variant='body1' sx={{ marginTop: '1.5rem', color: '#9e9e9e !important' }}>
