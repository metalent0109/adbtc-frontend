...
const SurfProjects: FC = () => {
  ...
  return (
    <Layout title={created ? 'Your surfing ads' : 'There is no ads yet'}>
                ...
                <TableBody>
                  {rows.map((row) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        {row.status} &nbsp; <br />
                        <Link component='button' underline='none' onClick={() => navigate('/surf/topup')}>
                      ...
                      <TableCell align="center">
                        ...
                        <IconButton onClick={() => navigate(`/surf/${row.id}`)}>
      ...
      <CustomButton variant='contained' btnColor='dark' onClick={() => navigate('/surf/add')}>
        {
